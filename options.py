...
from PyQt6.QtWidgets import (QWidget, QLabel, QComboBox, QCheckBox,
...
class Options(QWidget, ToolOptions):
    def __init__(self):
        ...
        for browser in [""] + YoutubeVideo.browsers:
    ...
    def set_defaults(self):
        ...
        self.logCheckBox.setCheckState(Qt.CheckState.Checked if self.debug["logging"] else Qt.CheckState.Unchecked)
